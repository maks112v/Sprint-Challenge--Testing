...
describe is a sub catagorie to orginaze test while it() is the acctual test

1. What is the point of `Test Driven Development`? What do you think about this approach?

It is to create software to pass tests that were created of requirements. It is a good way to make certian software but I have never tried it

1. Mention three types of automated tests.

Testing if page renders
Checking if api returns correct code
Checking if api returns correct data
